...
classify_url() {
  ...
  case "$url" in
    ...
    https://github.com/starship/starship/*|https://github.com/bjarneo/cliamp/*|https://github.com/pythops/bluetui*)
    ...
    https://quickshell.org/*|https://networkmanager.dev/*|https://specifications.freedesktop.org/*)
